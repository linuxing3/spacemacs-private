...
;; -- Xing Wenju's Spacemacs Configuration --
;; -- Contact: xingwenju@gmail.com --
;; -- MIT License --
...
config will do ... and packages will append the packkges to ..."
...
(defun dotspacemacs/user-config/experiments ()
  ...
  (when XING-ONLY?
    (load-file (os-path "~/.spacemacs.d/elisp/basic/init-chinese.fira.el"))
    ))
