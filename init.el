...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (wgrep toc-org smex org-projectile org-category-capture s dash org-present org-pomodoro alert log4e gntp org-download org-bullets org-brain org-plus-contrib ivy-hydra htmlize gnuplot evil-org counsel-projectile counsel swiper ivy which-key use-package pcre2el neotree macrostep hydra help-fns+ helm-themes helm-swoop helm-projectile helm-mode-manager helm-make helm-flx helm-descbinds helm-ag exec-path-from-shell evil-visualstar evil-escape elisp-slime-nav diminish bind-map auto-compile ace-window ace-jump-helm-line))))
(custom-set-faces
